      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Dispositivos de red</a>
          </div>
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Nuevo dispostitivo</p>
                   <p id="resp_new"></p>
                   <img src="../assets/gif/loading.gif" height="50px" width="50px" id="loading_new"></img>
                </div>
                <div class="card-body">
                  <form id="form_new" action="">
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="type" list="types">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Dirección IP</label>
                          <input type="text" class="form-control" id="ip">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Soporte Telnet</label>
                          <input type="text" class="form-control" id="telnet" list="yesno">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Soporte SSH</label>
                          <input type="text" class="form-control" id="ssh" list="yesno">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Marca</label>
                          <input type="text" class="form-control" id="brand" list="brands">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Crear dispositivo</button>
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Dispositivos</h4>
                  <p class="card-category">Eliminar dispositivo</p>
                  <p id="resp_del"></p>
                  <img src="../assets/gif/loading.gif" height="50px" width="50px" id="loading_del"></img>
                </div>
                <div class="card-body">
                  <form id="form_del" action="">
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Dirección MAC</label>
                          <input type="text" class="form-control" id="macnd">
                        </div>
                      </div>
                    </div>
                    </div>
                    <button type="submit" class="btn btn-primary pull-right">Borrar dispositivo</button>
                    <div class="clearfix"></div>
                  </form>
                </div>
              </div>
