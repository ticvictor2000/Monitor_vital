      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Gestión de puertos</a>
          </div>
        ...
        <div class="container-fluid">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <br />
              <select id="netdevices" class="select_ports">
                  <option value="null" disabled selected>--Dispositivo de red--</option>
              </select>
